...
*/
#ifndef PCD8544_INCLUDE
#define PCD8544_INCLUDE
//#define ARDUINO 100
...
class PCD8544 : public Print {
 public:
  ...
  void setSentidoDisplay(uint8_t flags);   // reverse(int) e setSentidoDisplay(int) para orienta��o da tela
  ...
  void drawbitmap(uint8_t x, uint8_t y, 
		  ...
		  uint8_t color);
  void imprime_grande(char *str);
  uint8_t cursor_x, cursor_y,textcolor;
 private:
  uint8_t textsize,font_size_x,font_size_y;
