...
#define AMOSTRA_PRONTA			1
#define AGUARDANDO_AMOSTRA		0
#define AMOSTRA_PEDIDA			2
#define AGUARDANDO_PEDIDO		3
...
public:  
  ...
  uint8_t fast_calcTrueTemperature();                    // calc temperature data b5 (only needed if AUTO_UPDATE_TEMPERATURE is false)
  uint8_t fast_calcTruePressure(long *_TruePressure);    // calc Pressure in Pa
  // dummy stuff
